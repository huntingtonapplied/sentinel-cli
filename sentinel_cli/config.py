"""Configuration management — reads/writes ~/.sentinel/config.yaml."""
...
DEFAULT_API_URL = os.getenv("SENTINEL_API_URL", "http://localhost:8017")
...
def get_api_key() -> Optional[str]:
    return os.environ.get("SENTINEL_API_KEY") or load_config().get("api_key")


def get_api_url() -> str:
    return os.environ.get("SENTINEL_API_URL") or load_config().get("api_url", DEFAULT_API_URL)
